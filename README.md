"""
COMPARAISON DES BALAYAGES : ÉTROITE, LARGE, ÉTENDU, OFFSET ÉLEVÉ
...
LES TROIS MODÈLES COMPARÉS
  ...
  "offsethigh"  modèle offset élevé : même chose sur la plage haute [2, 4],
                pour tester si l'entraînement sur des erreurs importantes
                aide ensuite sur des erreurs faibles
...
OÙ SE LIT LA GÉNÉRALISATION
Chaque modèle a son domaine d'entraînement tracé en fond sur la figure.
Seuls les points HORS de cette zone mesurent la généralisation ; à
l'intérieur, on mesure l'apprentissage du domaine couvert.

  modèle étendu       domaine [0, 2]  -> généralisation lue en 3,0 et 5,0
  modèle offset élevé domaine [2, 4]  -> généralisation lue VERS LE BAS
                                         (0 à 1,5) et en 5,0
...
AXES_NUMERIQUES = {
    "balayage_offset": {
        ...
        "plage_entrainement_offsethigh": (2.0, 4.0),
    },
    "balayage_bruit": {
...
# part ailleurs.
VARIANTES = ("narrow", "wide", "offsetsweep", "offsethigh")

COULEURS = {
    "narrow": "tab:blue",
    "wide": "tab:red",
    "offsetsweep": "tab:green",
    "offsethigh": "tab:purple",
}
...
ETIQUETTES = {
    ...
    "offsethigh": "modèle offset élevé",
}
